...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('a_f_p_data', function (Blueprint $table) {
            ...
            $table->text('date_of_onset')->nullable();
            $table->text('date_stool_collected')->nullable();
            $table->text('date_stool_received_in_lab')->nullable();
            ...
            $table->text('age_in_years')->nullable();
            $table->text('age_in_months')->nullable();
            $table->text('opv_doses')->nullable();
            $table->text('date_stool_sent_from_field')->nullable();
            $table->text('date_final_cell_culture_results')->nullable();
            $table->text('itd_mixture')->nullable();
            // $table->text('date_isolate_sent_for_sequencing')->nullable();
            // $table->text('date_isolate_received_in_lab_for_sequencing')->nullable();
