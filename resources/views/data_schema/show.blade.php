            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-custom bg-light-warning card-stretch gutter-b">
                        ...
                        <div class="card-body my-4">
                            <a href="#"
                                class="card-title font-weight-bolder text-warning font-size-h6 mb-4 text-hover-state-dark d-block">Available Attributes</a>
                            <div class="font-weight-bold text-muted font-size-sm">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-custom bg-light-info card-stretch gutter-b">
                        ...
                        <div class="card-body my-4">
                            <a href="#"
                                class="card-title font-weight-bolder text-info font-size-h6 mb-4 text-hover-state-dark d-block">Available Models</a>
                            <div class="font-weight-bold text-muted font-size-sm">
