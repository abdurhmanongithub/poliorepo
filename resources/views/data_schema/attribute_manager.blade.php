<div class="form-group row">
    ...
    <div data-repeater-list="attribute" class="col-lg-12">
        @foreach ($dataSchema?->getAttributes() as $key => $attribute)
            <div data-repeater-item="" class="form-group row align-items-center">
                <div class="col-md-4">
                    <label>Attribute Name</label>
                    <input type="text" required name="attribute[{{ $key }}][name]" class="form-control"
                ...
                <div class="col-md-2">
                    <div class="checkbox-list">
                        <label class="checkbox mt-4"
                            ...
                            <input name="attribute[{{ $key }}][is_required]" type="checkbox">
        ...
        @endforeach
        @if (count($dataSchema->getAttributes()) == 0)
            <div data-repeater-item="" class="form-group row align-items-center">
                <div class="col-md-4">
                    <label>Attribute Name</label>
