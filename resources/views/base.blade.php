...
<head>
    ...
    <meta charset="utf-8" />
    <title>
        @yield('title', 'Procurement and Property Management System')
    </title>
...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <!--end::Aside-->
            <!--begin::Wrapper-->
            <div class="d-flex flex-column flex-row-fluid wrapper pt-17" id="kt_wrapper">
                <!--begin::Header-->
                @section('header')
                ...
                <!--end::Header-->
                <!--begin::Content-->
                <div class="content d-flex flex-column flex-column-fluid align-content-center" id="kt_content">

                    <div class="card card-custom m-6 ">
                        @yield('filter')
                    </div>
        ...
        @foreach (['error', 'warning', 'success', 'info'] as $msg)
            @if (Session::has($msg))
                <script>
                    ...
                    toastr["{{ $msg }}"]("{{ Session::get($msg) }}", "{{ Str::ucfirst($msg) }} Message");
                </script>
            @endif
        @endforeach
    </div>
