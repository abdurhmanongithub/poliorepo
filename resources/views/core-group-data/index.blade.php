    ...
    <div class="card card-custom">
        <div class="card-header py-3">
            <div class="card-title align-items-start flex-column">
                ...
                <span class="text-muted font-weight-bold font-size-sm mt-1">{{ 'Core Group Data' }}</span>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-custom bg-light-warning card-stretch gutter-b">
                        ...
                        <div class="card-body my-4">
                            <a href="#"
                                class="card-title font-weight-bolder text-warning font-size-h6 mb-4 text-hover-state-dark d-block">Available
                                Attributes</a>
                            <div class="font-weight-bold text-muted font-size-sm">
                                @if ($columnCount)
                                    <span
                                        class="text-dark-75 font-weight-bolder font-size-h2 mr-2">{{ $columnCount }}</span>
                                @endif
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-custom bg-light-info card-stretch gutter-b">
                        ...
                        <div class="card-body my-4">
                            <a href="#"
                                class="card-title font-weight-bolder text-info font-size-h6 mb-4 text-hover-state-dark d-block">Available
                                Models</a>
                            <div class="font-weight-bold text-muted font-size-sm">
