        ...
        <div class="d-flex">
            ...
            <div class="flex-grow-1">
                ...
                <div class="flex-wrap d-flex align-items-center justify-content-between">
                    <div class="mr-3">
                        <!--begin::Name-->
                        <a href="#" class="mr-3 d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold">
                            {{ $dataSchema->name }}
                    ...
                    <div class="my-1 my-lg-0">
                        <div class="dropdown dropdown-inline">
                            <a href="#" class="px-5 btn btn-sm btn-primary font-weight-bolder dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Take Action</a>
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
                                <!--begin::Navigation-->
                                <ul class="navi navi-hover">
                                    <li class="navi-item">
                                        <a href="{{ route('data_schema.import.template.download', ['data_schema' => $dataSchema->id]) }}" class="navi-link">
        ...
        <div class="flex-wrap d-flex align-items-center">
            ...
            <div class="my-1 mr-5 d-flex align-items-center flex-lg-fill">
                ...
                <div class="d-flex flex-column text-dark-75">
                    ...
                    <span class="font-weight-bolder font-size-h5">
                        <span class="text-dark-50 font-weight-bold"></span>{{ count($dataSchema->getListOfAttributes() ?? []) }}</span>
                </div>
            ...
            <div class="my-1 mr-5 d-flex align-items-center flex-lg-fill">
                ...
                <div class="d-flex flex-column flex-lg-fill">
                    ...
                    <a href="#" class="text-primary font-weight-bolder">{{$dataSchema->totalCommuityMembers()}}</a>
            ...
            <div class="card-body pt-6 py-0" style="padding-left: 2px; padding-right: 2px;">
                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                    <div class="navi-item mb-2">
                        <a href="{{ route('data_schema.show', ['data_schema' => $dataSchema->id]) }}" class="navi-link  {{ strpos(Route::currentRouteName(), 'data_schema.show') === 0 ? 'active' : '' }} py-4">
                    ...
                    <div class="navi-item mb-2">
                        <a href="{{ route('data_schema.data.index', ['data_schema' => $dataSchema->id]) }}" class="navi-link {{ strpos(Route::currentRouteName(), 'data_schema.data.index') === 0 ? 'active' : '' }} py-4">
                            <span class="navi-icon mr-2">
                                <i class="fa fa-circle"></i>
                            </span>
                    ...
                    <div class="navi-item mb-2">
                        <a href="{{ route('data_schema.data.import.view', ['data_schema' => $dataSchema->id]) }}" class="navi-link {{ strpos(Route::currentRouteName(), 'data_schema.data.import.view') === 0 ? 'active' : '' }} py-4">
                            <span class="navi-icon mr-2">
                                <i class="fa fa-circle"></i>
                            </span>
                    ...
                    <div class="navi-item mb-2">
                        <a href="{{ route('data_schema.data.source', ['data_schema' => $dataSchema->id]) }}" class="navi-link {{ strpos(Route::currentRouteName(), 'data_schema.data.source') === 0 ? 'active' : '' }} py-4">
                            <span class="navi-icon mr-2">
                                <i class="fa fa-circle"></i>
                            </span>
                    ...
                    <div class="navi-item mb-2">
                        <a href="{{ route('data_schema.community.management',$dataSchema->id) }}" class="navi-link {{ strpos(Route::currentRouteName(), 'data_schema.community.management') === 0 ? 'active' : '' }} py-4">
                    ...
                    <div class="navi-item mb-2">
                        <a href="{{ route('data_schema.sms.management',$dataSchema->id) }}" class="navi-link {{ strpos(Route::currentRouteName(), 'data_schema.sms.management') === 0 ? 'active' : '' }} py-4">
