<div id="kt_header" class="header header-fixed">
 ...
 <i class="menu-icon flaticon-download"></i>&nbsp;
                <a >
                  Usermanual
                    <!--end::Svg Icon-->
                </a>
        ...
        <div class="topbar">
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex flex-column font-weight-bold">
                                            <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">
                                                New 8,000 Volunters
                                                Applications </a>
                                            <span class="text-muted"> 4th round training has been started </span>
                                        </div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Item-->
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-35px w-35px rounded-sm" src="{{ asset('assets/media/users/default.jpg') }}"
                            alt="" />
                    </div>
                </div>
                <!--end::Toggle-->
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item">
                            ...
                            <a href="#" class="navi-link">
                                ...
                                <form method="POST" class="p-0 m-0" action="{{ 'logout' }}">@csrf<button
                                        type="submit" class=" btn btn-link text-decoration-none">Logout</button>
                                </form>
                            </a>
                        </li>
                        <!--end::Item-->
            ...
            @auth
                <div class="topbar-item">
                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                        ...
                        <a href="{{ 'user.show' }}"><span
                                class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ auth()->user()->first_name }}</span></a>
