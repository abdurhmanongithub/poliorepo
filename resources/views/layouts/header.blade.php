    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm" src="{{ asset('assets/media/svg/flags/005-ethiopia.svg') }}" alt="" />
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
            ...
            <div class="topbar-item">
                ...
                <li class="nav-item pl-5">
                    <a href="{{$_ENV['SSO_URL']}}" class="nav-link btn btn-primary text-white text-nowrap">
                        <i class="fas fa-reply mr-2"></i>Back to SSO
                    </a>  
                </li>
                @else
